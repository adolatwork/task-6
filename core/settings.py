...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Celery Task Queue API',
    'DESCRIPTION': 'Django background task API that processes files asynchronously. Track task progress in DB, allow cancel/retry, and expose API endpoints to monitor status.',
    'VERSION': '1.0.0',
